...
public static class SaveFileSerializer
{
    ...
    public static string Serialize(Type storageType, object instance, bool encryptSaveFile)
    {
    ...
    public static void Deserialize<T>(string serializedData, bool saveFileIsEncrypted, ref T instance)
    {
        var serializer = new fsSerializer();
        GetJsonConverters(ref serializer);
