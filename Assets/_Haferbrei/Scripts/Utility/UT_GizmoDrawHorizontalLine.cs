...
public class UT_GizmoDrawHorizontalLine : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        var startingPoint = transform.position.With(x: -lenght/2f);
        var endPoint = transform.position.With(x: lenght / 2f);
