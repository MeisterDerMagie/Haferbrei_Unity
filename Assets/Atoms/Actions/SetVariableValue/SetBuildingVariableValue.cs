...
{
    /// <summary>
    /// Set variable value Action of type `Building`. Inherits from `SetVariableValue&lt;Building, BuildingVariable, BuildingConstant, BuildingReference, BuildingEvent, BuildingBuildingEvent&gt;`.
    /// </summary>
